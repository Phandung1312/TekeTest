...
class _AppApiService implements AppApiService {
  ...
  @override
  Future<HttpResponse<List<ErrorProductModel>>> getErrorProducts() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<HttpResponse<List<ErrorProductModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) =>
            ErrorProductModel.fromJson(i as Map<String, dynamic>))
        .toList();
  ...
  @override
  Future<HttpResponse<List<ColorModel>>> getColors() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
